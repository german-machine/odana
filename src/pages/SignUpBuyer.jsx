                ...
                <div className="bg-white w-full lg:w-[70%] relative m-auto lg:h-full lg:flex lg:justify-center lg:place-items-center lg:rounded-r-[110px]">
                    ...
                    <div className='w-full lg:w-[60%] m-auto'>
                        <div className="w-full mb-5">
                            ...
                            <p className="text-[18px] md:text-[30px] lg:text-[18px] text-[#7C7C7C] text-center">You're signing up as a buyer</p>
                        </div>
                        ...
                        <form action='/' onSubmit={handleSubmit} className="w-full md:w-[80%] m-auto">
                            ...
                            <div className="text-left mb-5 flex flex-col gap-2">
                                ...
                                <div className="border border-[#BDBDBD] flex items-center justify-between px-2 lg:px-0 py-1 lg:py-0 lg:rounded-md">
                                    ...
                                    <div className='w-full lg:py-0'>
                                        <input onChange={handleChange} value={inputValue.number} type="tel" name='number' placeholder='Phone Number' required className="hidden lg:block lg:text-left lg:px-2 py-2 lg:py-0 w-full bg-transparent focus:outline-none text-[#4F4F4F] md:text-[24px] lg:text-[20px] focus:ring-0 border-none " />
                            ...
                            <p className="text-[16px] md:text-[18px] lg:text-[16px] mb-3 font-normal text-[#7C7C7C] text-center">By continuing, you agree to our <span className="text-[#53B175]">Terms of Service</span> and <span className="text-[#53B175]">Privacy Policy</span></p>
